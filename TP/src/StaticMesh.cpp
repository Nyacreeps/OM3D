    ...
    for (int i = 0; i <= 1; i++) {
        for (int j = 0; j <= 1; j++) {
            for (int k = 0; k <= 1; k++) {
                ...
                int jsign = i * 2 - 1;
                int ksign = i * 2 - 1;
                vertices[i * 12 + j * 6 + k * 3].position = {
                    isign * lengthX / 2.0f, jsign * lengthY / 2.0f, ksign * lengthZ / 2.0f};
                vertices[i * 12 + j * 6 + k * 3 + 1].position = {
                    isign * lengthX / 2.0f, jsign * lengthY / 2.0f, ksign * lengthZ / 2.0f};
                vertices[i * 12 + j * 6 + k * 3 + 2].position = {
                    isign * lengthX / 2.0f, jsign * lengthY / 2.0f, ksign * lengthZ / 2.0f};
            }
        }
    }
